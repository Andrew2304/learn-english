...
export class LESSON1736911639808 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "lesson_word" ADD CONSTRAINT "FK_4f0b2c4f14c5529d83b7e5e9c94" FOREIGN KEY ("lesson_id") REFERENCES "lesson"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "lesson_answer" ADD CONSTRAINT "FK_2393f5b81c194d04377b4247c70" FOREIGN KEY ("question_id") REFERENCES "lesson_question"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "lesson_question" ADD CONSTRAINT "FK_b31a52da796d3e4f2434b05b42f" FOREIGN KEY ("lesson_word_id") REFERENCES "lesson_word"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "lesson_question" DROP CONSTRAINT "FK_b31a52da796d3e4f2434b05b42f"`);
        await queryRunner.query(`ALTER TABLE "lesson_answer" DROP CONSTRAINT "FK_2393f5b81c194d04377b4247c70"`);
        await queryRunner.query(`ALTER TABLE "lesson_word" DROP CONSTRAINT "FK_83efedca5e28bc7aea9bcd3d47a"`);
        await queryRunner.query(`ALTER TABLE "lesson_word" DROP CONSTRAINT "FK_4f0b2c4f14c5529d83b7e5e9c94"`);
